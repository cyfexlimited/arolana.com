...
urlpatterns = [
    ...
    path("video-commerce/feed/", views.video_commerce_feed_api, name="video_commerce_feed_api"),
    path("video-commerce/events/", views.video_commerce_event_api, name="video_commerce_event_api"),
