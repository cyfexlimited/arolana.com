...
from core.image_protection import ProtectedImageUploadPath, protect_uploaded_image, record_protected_image
...
class Vendor(BaseModel):
    ...
    shop_logo = models.ImageField(
        upload_to=ProtectedImageUploadPath('vendors/logos'),
        null=True,
        blank=True
    )
    shop_banner = models.ImageField(
        upload_to=ProtectedImageUploadPath('vendors/banners'),
        null=True,
        blank=True
    )
    ...
    def save(self, *args, **kwargs):
        protect_uploaded_image(self, "shop_logo")
        protect_uploaded_image(self, "shop_banner")
        ...
        record_protected_image(self, "shop_logo")
        record_protected_image(self, "shop_banner")
...
class Category(BaseModel):
    ...
    image = models.ImageField(
        upload_to=ProtectedImageUploadPath('categories'),
        null=True,
        blank=True,
        help_text="Category thumbnail image (for cards)"
    )
    background_image = models.ImageField(
        upload_to=ProtectedImageUploadPath('categories/backgrounds'),
        null=True,
        blank=True,
    ...
    def save(self, *args, **kwargs):
        ...
        protect_uploaded_image(self, "background_image")
        ...
        record_protected_image(self, "background_image")
...
class Brand(BaseModel):
    ...
    logo = models.ImageField(
        upload_to=ProtectedImageUploadPath('brands'),
        null=True,
        blank=True
    )
    ...
    def save(self, *args, **kwargs):
        protect_uploaded_image(self, "logo")
        ...
        record_protected_image(self, "logo")
...
class Product(BaseModel):
    ...
    main_image = models.ImageField(
        upload_to=ProtectedImageUploadPath('products'),
        null=True,
        blank=True,
    ...
    video_thumbnail = models.ImageField(
        upload_to=ProtectedImageUploadPath('products/video_thumbs'),
        null=True,
        blank=True
    )
    ...
    def save(self, *args, **kwargs):
        ...
        protect_uploaded_image(self, "main_image")
...
class Accessory(BaseModel):
    ...
    image = models.ImageField(
        upload_to=ProtectedImageUploadPath('accessories'),
        null=True,
        blank=True
    )
...
class ProductImage(BaseModel):
    ...
    image = models.ImageField(
        upload_to=ProtectedImageUploadPath('products/gallery'),
...
class ProductVariant(BaseModel):
    ...
    image = models.ImageField(
        upload_to=ProtectedImageUploadPath('products/variants'),
        null=True,
        blank=True
    )
...
class ProductVideo(BaseModel):
    ...
    thumbnail = models.ImageField(
        upload_to=ProtectedImageUploadPath('products/video_thumbs/additional'),
        null=True,
        blank=True
    )
    is_main = models.BooleanField(default=False)
    ...
    def save(self, *args, **kwargs):
        protect_uploaded_image(self, "thumbnail")
        super().save(*args, **kwargs)
...
class ReviewVideo(BaseModel):
    ...
    thumbnail = models.ImageField(
        upload_to=ProtectedImageUploadPath('reviews/thumbs'),
        null=True,
        blank=True
    )
    is_main = models.BooleanField(default=False)
...
class ProductListingBanner(BaseModel):
    ...
    background_image = models.ImageField(
        upload_to=ProtectedImageUploadPath("products/listing_banners"),
        blank=True,
        null=True,
        help_text="Main banner background image. Recommended: 1920x700."
    )
    side_image = models.ImageField(
        upload_to=ProtectedImageUploadPath("products/listing_banners/side"),
        blank=True,
        null=True,
    ...
    def save(self, *args, **kwargs):
        protect_uploaded_image(self, "background_image")
        protect_uploaded_image(self, "side_image")

        super().save(*args, **kwargs)

        record_protected_image(self, "background_image")
        record_protected_image(self, "side_image")
