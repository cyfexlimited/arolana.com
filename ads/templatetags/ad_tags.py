    ...
    try:
        ...
        for creative in creatives:
            all_ads.append({
                ...
                'cta_background_color': creative.cta_background_color or '',
                'cta_text_color': creative.cta_text_color or '',
        ...
        if placement_obj:
            ...
            for banner in banners:
                ...
                all_ads.append({
                    ...
                    'cta_background_color': banner.cta_background_color or '',
                    'cta_text_color': banner.cta_text_color or '',
                    'url': banner.cta_url,
                    'image': banner.image,
    ...
    try:
        ...
        for ad in ads:
            all_ads.append({
                ...
                'cta_background_color': ad.button_background_color or '',
                'cta_text_color': ad.button_text_color or '',
                'url': ad.url,
                'image': ad.image,
