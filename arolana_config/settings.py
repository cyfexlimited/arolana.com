...
PRIVATE_UPLOAD_AUDIT_STRICT_ALL_FIELDS = True
...
MIDDLEWARE = [
    ...
    "core.csrf.HeaderFirstCsrfViewMiddleware",
...
ACCOUNT_EMAIL_SUBJECT_PREFIX = "[Arolana] "
...
ACCOUNT_FORMS = {
    "signup": "accounts.forms.ArolanaAllauthSignupForm",
}
...
ADS_RECOMMENDATION_V2_WEB_ENABLED = config(
    "ADS_RECOMMENDATION_V2_WEB_ENABLED",
    default=False,
    cast=bool,
)
ADS_RECOMMENDATION_V2_MOBILE_WEB_ENABLED = config(
    "ADS_RECOMMENDATION_V2_MOBILE_WEB_ENABLED",
    default=False,
    cast=bool,
)
ADS_RECOMMENDATION_V2_APP_ENABLED = config(
    "ADS_RECOMMENDATION_V2_APP_ENABLED",
    default=False,
    cast=bool,
)
...
ADS_EXTERNAL_CAMPAIGN_PUBLISHING_ENABLED = config(
    "ADS_EXTERNAL_CAMPAIGN_PUBLISHING_ENABLED",
    default=False,
    cast=bool,
)
ADS_EXTERNAL_CAMPAIGN_TEST_MODE_ENABLED = config(
    "ADS_EXTERNAL_CAMPAIGN_TEST_MODE_ENABLED",
    default=False,
    cast=bool,
)
ADS_ADVERTISER_DASHBOARD_ENABLED = config(
    "ADS_ADVERTISER_DASHBOARD_ENABLED",
    default=False,
    cast=bool,
)
ADS_CREDENTIAL_ENCRYPTION_KEY = config(
    "ADS_CREDENTIAL_ENCRYPTION_KEY",
    default="",
)
ADS_META_CONNECTION_ENABLED = config("ADS_META_CONNECTION_ENABLED", default=False, cast=bool)
ADS_GOOGLE_CONNECTION_ENABLED = config("ADS_GOOGLE_CONNECTION_ENABLED", default=False, cast=bool)
ADS_TIKTOK_CONNECTION_ENABLED = config("ADS_TIKTOK_CONNECTION_ENABLED", default=False, cast=bool)
...
ADS_GOOGLE_LOGIN_CUSTOMER_ID = config("ADS_GOOGLE_LOGIN_CUSTOMER_ID", default="")
ADS_GOOGLE_TEST_ACCOUNT_ALLOWLIST = config(
    "ADS_GOOGLE_TEST_ACCOUNT_ALLOWLIST",
    default="",
    cast=lambda value: [item.strip() for item in value.split(",") if item.strip()],
)
ADS_TIKTOK_CLIENT_ID = config("ADS_TIKTOK_CLIENT_ID", default="")
ADS_TIKTOK_APP_ID = config("ADS_TIKTOK_APP_ID", default="")
ADS_TIKTOK_CLIENT_SECRET = config("ADS_TIKTOK_CLIENT_SECRET", default="")
ADS_LINKEDIN_CLIENT_ID = config("ADS_LINKEDIN_CLIENT_ID", default="")
ADS_LINKEDIN_CLIENT_SECRET = config("ADS_LINKEDIN_CLIENT_SECRET", default="")
ADS_ATTRIBUTION_CLICK_LOOKBACK_DAYS = config(
    "ADS_ATTRIBUTION_CLICK_LOOKBACK_DAYS",
    default=7,
    cast=int,
)
ADS_ATTRIBUTION_VIEW_LOOKBACK_DAYS = config(
    "ADS_ATTRIBUTION_VIEW_LOOKBACK_DAYS",
    default=1,
    cast=int,
)
...
JAZZMIN_SETTINGS = {
    ...
    'site_header': 'Arolana',
    'site_brand': 'Arolana',
    'site_logo': 'admin/images/arolana-logo.png',
    ...
    'icons': {
        ...
        'core.AdminAppearance': 'fas fa-palette',
        'core.SiteSettings': 'fas fa-cog',
        'core.PromoBanner': 'fas fa-bullhorn',
        'products.Product': 'fas fa-box',
        'products.ProductVariant': 'fas fa-layer-group',
        'products.Category': 'fas fa-folder-tree',
        'products.Brand': 'fas fa-copyright',
        'products.Accessory': 'fas fa-plug',
        'orders.Order': 'fas fa-receipt',
        'orders.Cart': 'fas fa-shopping-cart',
        'hero_banners.HeroBanner': 'fas fa-images',
        'homepage.HomepageBanner': 'fas fa-panorama',
        'homepage.HomepageVideoSection': 'fas fa-video',
        'ads.AdBanner': 'fas fa-rectangle-ad',
        'ads.AdCampaign': 'fas fa-bullhorn',
        'ads.AdPlacement': 'fas fa-map-marker-alt',
        'notifications.Notification': 'fas fa-bell',
        'notifications.NotificationPreference': 'fas fa-sliders-h',
        'currency.Currency': 'fas fa-money-bill-wave',
        'vendors.VendorProfile': 'fas fa-store',
        'vendors.VendorSubscriptionPlan': 'fas fa-tags',
        'manufacturers.Manufacturer': 'fas fa-industry',
        'manufacturers.ManufacturerApplication': 'fas fa-clipboard-check',
        'kyc.KYCRecord': 'fas fa-id-card',
