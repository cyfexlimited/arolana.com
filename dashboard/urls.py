...
urlpatterns = [
    ...
    path("vendor/quote-requests/<int:quote_id>/messages/", views.vendor_quote_messages, name="vendor_quote_messages"),
    path("vendor/quote-requests/<int:quote_id>/messages/send/", views.vendor_quote_send_message, name="vendor_quote_send_message"),
