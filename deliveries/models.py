...
from core.private_upload_validation import (
    ...
    validate_rider_document_upload,
)
...
class DeliveryVehicle(BaseModel):
    ...
    base_capacity_kg = models.DecimalField(
        max_digits=8,
        decimal_places=2,
        default=Decimal("10.00"),
    )

    base_speed_kmph = models.DecimalField(
        max_digits=8,
        decimal_places=2,
...
class RiderProfile(BaseModel):
    ...
    RIDER_TYPE_CHOICES = [
        ...
        (
            RIDER_INDEPENDENT,
            "Independent Dispatch Rider",
        ),
        (
            RIDER_ADMIN_ASSIGNED,
            "Admin Assigned Rider",
        ),
    ]
    ...
    id_document = models.FileField(
        upload_to="delivery/riders/id_documents/",
        blank=True,
        null=True,
        validators=[
            validate_rider_document_upload,
    ...
    driver_license = models.FileField(
        upload_to="delivery/riders/licenses/",
        blank=True,
        null=True,
        validators=[
            validate_rider_document_upload,
    ...
    vehicle_document = models.FileField(
        upload_to="delivery/riders/vehicle_documents/",
        blank=True,
        null=True,
        validators=[
            validate_rider_document_upload,
    ...
    # =========================================================================
    # PRIVATE RIDER IMAGES
    # =========================================================================

    profile_photo = models.ImageField(
        upload_to="delivery/riders/photos/",
        blank=True,
        null=True,
        validators=[
            validate_private_profile_image_upload,
    ...
    dashboard_image = models.ImageField(
        upload_to="delivery/riders/banners/",
        blank=True,
        null=True,
        validators=[
            validate_private_profile_image_upload,
    ...
    profile_edit_pending_data = models.JSONField(
        default=dict,
        blank=True,
    )

    profile_edit_requested_at = models.DateTimeField(
        null=True,
        blank=True,
    )

    profile_edit_available_at = models.DateTimeField(
        null=True,
        blank=True,
    )
    ...
    payout_bank_country = models.CharField(
        max_length=80,
        default="Nigeria",
        blank=True,
    )

    payout_preferred_currency = models.CharField(
        max_length=10,
        default="NGN",
        blank=True,
    )
    ...
    def can_request_profile_edit(self):
        ...
        return (
            timezone.now()
            >= self.profile_edit_available_at
        )
...
class DeliveryRequest(BaseModel):
    ...
    order = models.ForeignKey(
        "orders.Order",
        on_delete=models.CASCADE,
        related_name="live_delivery_requests",
    )

    legacy_delivery = models.OneToOneField(
        "orders.DeliveryRequest",
        on_delete=models.SET_NULL,
        null=True,
        blank=True,
        related_name="live_delivery",
    )
    ...
    dropoff_name = models.CharField(
        max_length=160,
        blank=True,
    )

    dropoff_phone = models.CharField(
        max_length=50,
        blank=True,
    )
    ...
    weight_fee = models.DecimalField(
        max_digits=12,
        decimal_places=2,
        default=Decimal("0.00"),
    )
    ...
    is_ready_for_rider = models.BooleanField(
        ...
        db_index=True,
        help_text=(
            "Show this delivery to riders only after vendor/admin "
            "confirms it is ready for pickup."
        ),
    )
    ...
    #
    # Current field is ImageField, so use the image-only validation policy.
    # A future proof_video FileField can use validate_delivery_evidence_upload.
    # =========================================================================
    ...
    def set_status(
        ...
        if self.rider_id:
            ...
            if (
                ...
                and not self.rider.is_available
                and not self.rider.is_suspended
            ):
    ...
    def sync_legacy_delivery_status(self):
        ...
        legacy_status = (
            legacy_status_map.get(
                self.status
            )
        )

        if legacy_status:
            self.legacy_delivery.tracking_status = (
                legacy_status
            )

            self.legacy_delivery.delivery_fee = (
                self.delivery_fee
            )

            self.legacy_delivery.save(
                update_fields=[
                    "tracking_status",
                    "delivery_fee",
                    "updated_at",
    ...
    def credit_rider_wallet(self):
        ...
        self.rider.completed_deliveries = (
            self.rider.completed_deliveries
            + 1
        )
...
class DeliveryStatusHistory(BaseModel):
    ...
    status = models.CharField(
        max_length=30,
        choices=DeliveryRequest.STATUS_CHOICES,
    )
