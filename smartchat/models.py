...
class SmartChatConversation(models.Model):
    ...
    session_key = models.CharField(
        ...
        db_index=True,
        help_text=(
            "Visitor session key for guests."
        ),
    )
    ...
    assigned_admin = models.ForeignKey(
        ...
        blank=True,
        related_name=(
            "assigned_smart_chat_conversations"
        ),
        limit_choices_to={
            "is_staff": True,
        },
    ...
    admin_requested_at = models.DateTimeField(
        null=True,
        blank=True,
    )
    ...
    def customer_avatar_url(self):
        ...
        Mobile customers store their app profile image separately, while
        web customers may have an account avatar or profile avatar.
        """
        ...
        try:
            ...
            if mobile_customer_id:
                ...
                if (
                    mobile_customer
                    and mobile_customer.profile_image
                ):
                    return (
                        mobile_customer
                        .profile_image
...
class SmartChatMessage(models.Model):
    ...
    image = models.ImageField(
        ...
        help_text=(
            "Optional customer/admin image attachment."
        ),
    )
    ...
    def __str__(self):
        return (
            f"{self.get_sender_type_display()} "
...
class SmartChatSupportTicket(models.Model):
    ...
    assigned_admin = models.ForeignKey(
        ...
        blank=True,
        related_name=(
            "assigned_smartchat_support_tickets"
        ),
        limit_choices_to={
            "is_staff": True,
        },
    ...
    audience = models.CharField(
        max_length=30,
        choices=(
            SmartChatConversation.AUDIENCE_CHOICES
        ),
        default=(
    ...
    class Meta:
        ...
        verbose_name = (
            "Smart Chat Support Ticket"
        )

        verbose_name_plural = (
            "Smart Chat Support Tickets"
        )
...
class AILearnedKnowledge(models.Model):
    ...
    answer_type = models.CharField(
        max_length=40,
        choices=(
            AIKnowledgeBase.ANSWER_TYPE_CHOICES
        ),
        default="customer_answer",
        db_index=True,
    )
    ...
    privacy_safe = models.BooleanField(
        default=False,
        db_index=True,
    )
...
class AITrainingData(models.Model):
    ...
    audience = models.CharField(
        max_length=30,
        choices=(
            AIKnowledgeBase.AUDIENCE_CHOICES
        ),
        default="all",
        db_index=True,
    )
...
class HumanTakeoverRequest(models.Model):
    ...
    assigned_to = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name="assigned_ai_takeovers",
        limit_choices_to={
            "is_staff": True,
        },
    )
    ...
    priority = models.CharField(
        max_length=20,
        choices=(
            SmartChatSupportTicket.PRIORITY_CHOICES
        ),
        default=(
            SmartChatSupportTicket.PRIORITY_NORMAL
        ),
        db_index=True,
    )
...
class AIUnansweredQuestion(models.Model):
    ...
    reviewed_by = models.ForeignKey(
        ...
        blank=True,
        related_name=(
            "reviewed_ai_unanswered_questions"
        ),
    )
...
class AIIntentLog(models.Model):
    ...
    used_memory = models.BooleanField(
        default=False,
    )

    triggered_search = models.BooleanField(
        default=False,
    )

    triggered_handover = models.BooleanField(
        default=False,
    )
