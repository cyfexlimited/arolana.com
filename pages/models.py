...
class Page(BaseModel):
    ...
    sidebar_content = CKEditor5Field(
        blank=True,
...
class ContactPageSettings(BaseModel):
    ...
    title = models.CharField(
        max_length=120,
        default="Arolana Contact Settings",
    )

    support_email = models.EmailField(
        default="contact@arolana.com",
    )
    ...
    coverage_text = models.CharField(
        max_length=255,
        default=(
            "Nigeria, Africa, and global "
            "marketplace support"
        ),
    )

    protection_title = models.CharField(
        max_length=120,
        default="Marketplace Protection",
    )

    protection_text = models.TextField(
        default=(
            "For order issues, include your order number, "
            "delivery tracking code, vendor name, and "
...
class ContactQuickAction(BaseModel):
    ...
    url = models.CharField(
        max_length=300,
        help_text=(
            "Use a path like /help/ or a full URL."
        ),
    )
...
class JobPosition(BaseModel):
    ...
    benefits = CKEditor5Field(
        blank=True,
        help_text=(
            "Benefits specific to this position"
        ),
    )
