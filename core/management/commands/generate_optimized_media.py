    ...
    def handle(self, *args, **options):
        ...
        jobs = [
            ...
            (Product.objects.filter(is_active=True, approval_status='approved'), [
                ...
                ('main_image', 'product_card_large'),
                ('main_image', 'product_gallery'),
                ('main_image', 'product_detail'),
                ('video_thumbnail', 'product_thumb'),
            ]),
            (ProductImage.objects.filter(is_active=True), [('image', 'product_thumb'), ('image', 'product_card'), ('image', 'product_card_large'), ('image', 'product_gallery'), ('image', 'product_detail')]),
            (ProductVariant.objects.filter(is_active=True), [('image', 'product_thumb'), ('image', 'product_card'), ('image', 'product_card_large'), ('image', 'product_gallery'), ('image', 'product_detail')]),
            (ProductVariantImage.objects.filter(is_active=True), [('image', 'product_thumb'), ('image', 'product_card'), ('image', 'product_card_large'), ('image', 'product_gallery'), ('image', 'product_detail')]),
