...
class CustomUserAdmin(UserAdmin):
    ...
    def avatar_preview(self, obj):
        ...
        avatar_name = obj.username or obj.email or "Arolana User"
        avatar_url = f'https://ui-avatars.com/api/?name={avatar_name}&background=0066b3&color=fff&size=50'
        return format_html(
            '<img src="{}" width="50" height="50" style="border-radius: 50%; object-fit: cover;" />',
            avatar_url,
        )
...
class UserProfileAdmin(admin.ModelAdmin):
    ...
    def avatar_preview(self, obj):
        ...
        avatar_name = obj.user.username or obj.user.email or "Arolana User"
        return format_html(
            '<img src="https://ui-avatars.com/api/?name={}&background=0066b3&color=fff&size=40" width="40" height="40" style="border-radius: 50%;" />',
            avatar_name,
        )
