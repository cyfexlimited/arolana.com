...
class BlogCategoryAdmin(admin.ModelAdmin):
    ...
    def color_preview(self, obj):
        return format_html(
            '<div style="width: 30px; height: 30px; background: {}; border-radius: 50%; border: 1px solid #ddd;"></div>',
            obj.color,
        )
...
class BlogPostAdmin(admin.ModelAdmin):
    ...
    list_filter = [
        ...
        'created_at',
        'show_article_top_ad',
        'show_article_native_ad',
        'show_article_after_author_ad',
        'show_article_footer_ad',
        'show_sidebar_top_ad',
        'show_sidebar_mid_ad',
        'show_sidebar_bottom_ad',
        'show_sidebar_sticky_ad',
    ...
    fieldsets = (
        ...
        ('Article Ad Placement Controls', {
            ...
            'description': (
                'Choose exactly where ads appear on this article page. '
                'For product page side-reader behavior, use the Product Article Link inline below. '
                'That inline controls same-page split reader, same page, new tab, and whether imported ads/widgets are shown.'
            ),
            'classes': ('wide',),
        }),
        ('SEO & Metadata', {
...
class NewsletterSubscriberAdmin(admin.ModelAdmin):
    ...
    def status_badge(self, obj):
        ...
        return format_html(
            '<span style="background: #ef4444; color: white; padding: 2px 8px; border-radius: 12px; font-size: 11px;">Inactive</span>'
        )
